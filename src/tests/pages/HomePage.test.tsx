...
// Create a reusable mock builder that returns itself for chaining
const createPostgrestBuilder = (response = createMockResponse()) => {
  const builder = {
    ...
    // Required properties from PostgrestFilterBuilder
    method: 'GET',
    ...
    // Final order method that returns a new builder with the response
